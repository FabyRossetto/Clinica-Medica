...
public class ListadoMedicos extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Especialidad", "Documento", "Email"
            }
        ) {
   ...
   private String token;  // Atributo para almacenar el token
    ...
    public void cargarMedicos() {
        String apiUrl = "http://localhost:8080/medicos";
        try {
            // Crear conexión HTTP
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                for (int i = 0; i < contentArray.length(); i++) {
                    JSONObject medico = contentArray.getJSONObject(i);
                    Object[] rowData = {
                        medico.getLong("id"),
                        medico.getString("nombre"),
                        medico.getString("especialidad"),
                        medico.getString("documento"),
                        medico.getString("email")
                    };
                    tableModel.addRow(rowData);
                }
            } else {
                mostrarMensaje("Error al cargar los medicos: " + responseCode, "Error", JOptionPane.ERROR_MESSAGE);
            }
