 ...
 * @author Faby
 */
public class BorrarPaciente extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("BORRAR UN PACIENTE DEL SISTEMA");
        ...
        borrar.setBackground(new java.awt.Color(102, 204, 255));
        ...
        jLabel1.setText("LA ACCION QUE ESTA A PUNTO DE HACER ES IRREVOCABLE.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(idPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    public BorrarPaciente(String token) {
        this.token = token;
        initComponents();
        setupActionListeners();
    }

    public BorrarPaciente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setupActionListeners();
    }
    ...
    private void borrarPaciente(java.awt.event.ActionEvent evt) {
        try {
...
// Construir la solicitud DELETE sin cuerpo
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create(url))
                    .header("Content-Type", "application/json")
                    .header("Authorization", "Bearer " + token)
                    .DELETE() // Eliminar el cuerpo ya que DELETE generalmente no lo lleva
                    .build();
            ...
            client.sendAsync(request, HttpResponse.BodyHandlers.ofString())
                    .thenApply(response -> {
                        if (response.statusCode() >= 200 && response.statusCode() < 300) {
                            mostrarMensaje("La eliminacion del registro fue exitosa! " , "Éxito", JOptionPane.INFORMATION_MESSAGE);
                            ...
                            mostrarMensaje("El registro no se pudo eliminar" + response.statusCode(), "Error", JOptionPane.ERROR_MESSAGE);
                        }
                        return response;
                    })
                    .exceptionally(e -> {
